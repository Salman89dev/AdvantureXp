...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Spartan:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="preconnect" href="https://fonts.gstatic.com">
    ...
    <header>
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- -----------------------Logo  ---------------------- -->
                <logo>
                    <div class="col-md-3 headerLogo"><a href="<?php echo home_url('/'); ?>"title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>"rel="home"><?php echo $options['logo']; ?> </a></div>
                </logo>
                ...
                <div>
                  <nav class="nav"><?php wp_nav_menu(array('container_class' => 'menu-header', 'theme_location' => 'primary')); ?></nav>
                </div>
                <div class="advantureBtn">
                  <a href="#"> Adventure Application </a>
                </div>
