...
function fix_slider(){
	?>
	<script>	
	var num = $("ul.slick-dots").find("li").length;
	if (num > 1) {
	  var last  = num;
	}
	var first = '01';		
	jQuery('ul.slick-dots').prepend("<span class='slick_first'>" + first + "</li>");
	jQuery('ul.slick-dots').append("<span  class='slick_last'>" + 0+ last + "</li>");
	</script>
	<?php
}
add_action('wp_footer','fix_slider');


<iframe src="https://player.vimeo.com/video/521079269" width="640" height="400" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
<p><a href="https://vimeo.com/521079269">ADVENTURE-EXP-SPLASH-PAGE (1)</a> from <a href="https://vimeo.com/user135318904">sundeep kumar</a> on <a href="https://vimeo.com">Vimeo</a>.</p>